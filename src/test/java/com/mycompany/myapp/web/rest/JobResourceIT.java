...
class JobResourceIT {
    ...
    public static Job createEntity(EntityManager em) {
        Job job = new Job().name(DEFAULT_NAME).salary(DEFAULT_SALARY);
        return job;
    }
    ...
    public static Job createUpdatedEntity(EntityManager em) {
        Job job = new Job().name(UPDATED_NAME).salary(UPDATED_SALARY);
        return job;
    }
    ...
    void createJob() throws Exception {
        ...
        assertThat(testJob.getSalary()).isEqualByComparingTo(DEFAULT_SALARY);
    }
    ...
    void putNewJob() throws Exception {
        ...
        updatedJob.name(UPDATED_NAME).salary(UPDATED_SALARY);
    ...
    void partialUpdateJobWithPatch() throws Exception {
        ...
        partialUpdatedJob.salary(UPDATED_SALARY);
        ...
        Job testJob = jobList.get(jobList.size() - 1);
        assertThat(testJob.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testJob.getSalary()).isEqualByComparingTo(UPDATED_SALARY);
    }
    ...
    void fullUpdateJobWithPatch() throws Exception {
        ...
        partialUpdatedJob.name(UPDATED_NAME).salary(UPDATED_SALARY);
