...
class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().name(DEFAULT_NAME).lastName(DEFAULT_LAST_NAME).birthDate(DEFAULT_BIRTH_DATE);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().name(UPDATED_NAME).lastName(UPDATED_LAST_NAME).birthDate(UPDATED_BIRTH_DATE);
        return employee;
    }
    ...
    void putNewEmployee() throws Exception {
        ...
        updatedEmployee.name(UPDATED_NAME).lastName(UPDATED_LAST_NAME).birthDate(UPDATED_BIRTH_DATE);
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.lastName(UPDATED_LAST_NAME).birthDate(UPDATED_BIRTH_DATE);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.name(UPDATED_NAME).lastName(UPDATED_LAST_NAME).birthDate(UPDATED_BIRTH_DATE);
